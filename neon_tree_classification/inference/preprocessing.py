...
def load_image(image_input: Union[str, Path, Image.Image, np.ndarray, torch.Tensor]) -> Image.Image:
    """
    ...
    if isinstance(image_input, np.ndarray):
        ...
        if image_input.ndim == 2:
            ...
            if image_input.shape[0] == 3 and image_input.shape[0] < image_input.shape[2]:
                # (3, H, W) -> (H, W, 3)
...
def normalize_rgb(image: Union[Image.Image, np.ndarray], method: str = '0_1') -> np.ndarray:
    """
