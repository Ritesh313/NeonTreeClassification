...
CLEAN VERSION - Simple logging with one consolidated log at the end.
...
Usage:
    ...
    python neon_downloader_clean.py --coords-file crown_metadata.gpkg --output-dir ./neon_tiles

    # Download specific site/year
    python neon_downloader_clean.py --coords-file crown_metadata.gpkg --site BART --year 2019
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Download NEON tiles for crowns (Clean Version)."
    )
    parser.add_argument(
        "--coords-file",
        type=str,
    ...
    downloader = NEONDownloaderClean(base_output_dir=args.output_dir)
